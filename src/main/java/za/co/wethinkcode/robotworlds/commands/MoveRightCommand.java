...
/**
 * The right command changes the direction of the robot that it is currently facing. It turns clockwise.
 */
public class MoveRightCommand extends Commands {

    public MoveRightCommand(GsonRequest gsonRequest) {
        super(gsonRequest);
    }
    ...
    public GsonResponse executeCommand(World world) {
        ...
        // Updates the direction the robot is facing by turning right.
